...
HAND_SANITIZERS = [31808537264211, 31620018667603, 31808444432467]
...
eligible_items = Input.cart.line_items.select do |line_item|
  ...
  !product.gift_card? && HAND_SANITIZERS.include?(variant_id)
end

discounted_line_items = partition(Input.cart, eligible_items)
discounted_line_items.each do |line_item|
  line_item.change_line_price(Money.zero, message: "BOGO HAND SANITIZER")
end
